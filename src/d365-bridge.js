...
export const bridge = {
  ...
  async getProcessStages(processId) {
    if (!isExtension) {
      const demo = {
        proc1: [{ id: "stg1", name: "Identify", category: "Identify" }, { id: "stg2", name: "Research", category: "Research" }, { id: "stg3", name: "Resolve", category: "Resolve" }],
        proc2: [{ id: "stgA", name: "Qualify", category: "Qualify" }, { id: "stgB", name: "Develop", category: "Develop" }, { id: "stgC", name: "Close", category: "Close" }],
      };
      return demo[processId] || [];
    }
    return callD365("getProcessStages", { processId });
  },
