      ...
      <div style={{width:"100%",maxWidth:440,textAlign:"center"}}>
        <div style={{marginBottom:28}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginBottom:6}}>
            ...
            <span style={{fontSize:bp.mobile?20:22,fontWeight:700,color:C.tx}}>{t("conn.title")}</span>
          </div>
          <p style={{color:C.txm,fontSize:15,margin:0}}>{t("conn.subtitle")}</p>
        </div>
        <div style={{...crd({padding:bp.mobile?16:22})}}>
          {connecting?(
            ...
            <div>
              ...
              <button onClick={onConnect} style={bt(`linear-gradient(135deg,${C.vi},${C.vil})`,{width:"100%",justifyContent:"center",padding:"10px 0",fontSize:15})}><I.Zap/> {t("conn.demo")}</button>
